    ...
    <div class="menu-page">
      <div class="menu-inner">
        ...
        <section class="chef-note">
          ...
          <p class="chef-note-announcement">승객 여러분 안녕하십니까!! 지금 한국으로 향하는 대한항공의 운전을 맡은 기장의 그냥 아는 사람입니다. 세상에서 제일 잘 이쁘게 드시고 이제 너무나도 배고프시다는 한 손님의 요청에 따라 추가 기내식이 나갈 예정입니다. 이 기내식은 스페셜 메뉴로 전 세계에서 단 한 손님에게만 나갈 겁니다. 그러니 다른 손님들은 쳐다도 보지 마시고, 제발 그 분만 편히 이 코스요리를 즐기기 바랍니다.</p>

          <p>오늘 코스는 10개의 요리로 준비되어 있습니다. 하나씩 음미하고 느끼시며 천천히 이제 이걸 즐기셨으면 좋겠습니다… 지금까지 기장을 사칭한 최구였습니다…!!!!</p>

          <p>은비야 그리고 헤드폰 있으면 헤드폰 써봐. 아마 노래가 나오고 있을 거야. 이 노래들은 내가 고른 거야. 근데 이게 좀 정신없거나 하면 그냥 끄고. 그게 아마 읽기는 편할 거야!</p>
